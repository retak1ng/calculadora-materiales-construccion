...
export class ContrapisoComponent {
  matUsandoCalYCemento = [
    ...
    { nombre: '4 Arena', cantidad: 0.515, unidad: 'm3', input: 0, medComercial: 1 },
    { nombre: '6 Cascote', cantidad: 0.770, unidad: 'm3', input: 0, medComercial: 1 },
  ]

  matUsandoCemento = [
    { nombre: '1 Cemento', cantidad: 108.00, unidad: 'kg', input: 0, medComercial: 50 },
    { nombre: '4 Arena', cantidad: 0.430, unidad: 'm3', input: 0, medComercial: 1 },
    { nombre: '8 Cascote', cantidad: 0.900, unidad: 'm3', input: 0, medComercial: 1 },
  ]
}
